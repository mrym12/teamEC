...
//各条件でtable product_infoより商品を検索し、情報を取得しproductInfoDtoListを作成する
...
public class ProductInfoDAO {
	...
	//categoryIdで検索しproductInfoDtoListを作成
	...
	//keywordListで検索しproductInfoDtoListを作成
	...
	//keywordList、categoryIdで検索しproductInfoDtoListを作成
